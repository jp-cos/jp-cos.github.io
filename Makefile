...
all:
	bundle update
	bundle exec catttl commentary commentary-metadata cs-basic-advanced cs-citations \
		cs-commentary cs-items cs-metadata cs-period cs-revision cs-dataset \
		dataset disability-category \
...
clean:
	-rm -rf [78][0-9A-Za-z][0-9A-Za-z]/ Kidergarden*/ Elementary*/ LowerSecondary*/ UpperSecondary*/ disabilityCategory/ period/ school/ stage/ source/ commentary/
